<template>
  ...
  >
    <div
      ...
      :key="integration.id"
      class="group relative border bg-gray-50 rounded-lg p-4 flex flex-col items-center hover:border hover:border-indigo-600 justify-center cursor-pointer"
    >
      <div
        v-if="selectedIntegration.id === integration.id"
        class="w-full flex items-center justify-center bg-opacity-10 rounded-lg"
      >
        <svg
  ...
  <div v-if="selectedIntegration.id === 1" class="py-5">
    <button
      ...
      style="
        ...
        border-radius: 4px;
      "
      class="text-white outline-none focus:ring-0 font-medium hover:bg-[#259018] transition-colors duration-200 flex items-center justify-center"
    >
